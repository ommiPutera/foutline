    ...
    <div className="relative">
      ...
      {isOpen && (
        <form
          ...
          className="animate-in fade-in slide-in-from-top-1 fixed top-full z-[99999] mt-1 flex w-60 overflow-hidden rounded border border-gray-200 bg-white p-1 shadow-xl"
        >
          <input
            ref={inputRef}
            type="text"
