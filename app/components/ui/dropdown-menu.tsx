...
>(({ className, vaiant, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-3 py-2 text-xs outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      className,
      {
        "text-destructive focus:text-destructive focus:bg-destructive/10": vaiant === "destructive"
      }
    )}
    {...props}
  />
