...
function Shell({children}: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div className="bg-background h-full">
      <div className="flex">
        <div className="border-border fixed z-50 hidden h-full w-full max-w-[var(--sidebar-width)] border-r md:block">
          <Sidebar />
        </div>
        <div className="relative h-full w-full md:ml-auto md:w-[calc(100%_-_var(--sidebar-width))]">
          <div className="relative h-full w-full">
            ...
            <div className="mx-auto mt-[var(--header-height)] max-w-screen-2xl px-3.5 py-6 md:mt-0">
              {children}
            </div>
          </div>
        </div>
