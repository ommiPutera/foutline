...
function Hero() {
  return (
    <div className="max-w-screen-2xl px-5vw mx-auto py-10 md:py-4">
      <div className="max-w-2xl mx-auto text-center flex flex-col gap-6 md:gap-8">
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <h2 className="text-4xl md:text-7xl font-semibold md:font-bold line-clamp-2">Kelola, dan lacak keuangan Anda.</h2>
        </div>
