...
function Hero() {
  return (
    <div className="px-5vw mx-auto flex max-w-screen-xl flex-col gap-2 py-4 md:flex-row md:gap-2 md:pb-36 md:pt-12">
      <div className="mt-20 w-full">
        <div className="flex flex-col gap-6">
          <h2 className="max-w-xl text-5xl font-bold tracking-tight md:text-[60px] 4xl:text-[45px] w-full">
      ...
      <div className="relative w-full">
        <div className="absolute left-0 top-0 hidden w-[910px] dark:w-[720px] md:block">
          <img
            src="/dark-asset.png"
            alt=""
