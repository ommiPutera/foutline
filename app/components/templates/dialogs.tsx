...
function CreatePostDialog({
  ...
  onTrigger?: () => void, withoutTooltip?: boolean
}) {
              ...
              <div className="flex w-full items-center gap-4">
                ...
                <Tooltip>
                  <TooltipTrigger className="h-full w-1/2">
                    <Toggle disabled className="flex h-full flex-1 flex-col items-start gap-4 rounded-md p-4 text-left data-[state=on]:border-teal-500">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <p className="text-xs font-normal leading-4 text-muted-foreground">Buat halaman berdasarkan koleksi dari pengguna lain</p>
                      </div>
                    </Toggle>
                  </TooltipTrigger>
