  ...
  return (
    <div className="h-full bg-background">
      <div className="flex">
        ...
        <div className="w-full md:ml-auto md:w-[calc(100%_-_280px)]">
          <div className="top-0 h-full w-full">
            <div className="sticky top-0 mx-auto flex max-w-screen-2xl items-center justify-between border-b border-border bg-background px-6 py-3 pr-8">
