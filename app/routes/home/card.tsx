  ...
  return isDeleting ? null : (
    ...
    >
      <Card
        key={id}
        className={cn(
          'hover:border-muted-foreground/60 col-span-1 cursor-pointer overflow-hidden border-[1.5px]',
...
function CardBadge({ status, type }: Pick<Post, 'status' | 'type'>) {
  ...
  return (
    <div
      className={cn(
        'text-foreground line-clamp-1 w-fit rounded-sm px-1.5 py-[3.5px] text-[9px] md:text-[10px] leading-none',
